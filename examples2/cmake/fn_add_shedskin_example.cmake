...
function(add_shedskin_example sys_modules)
    ...
    add_custom_command(OUTPUT ${translated_files}
        COMMAND ${Python_EXECUTABLE} -m shedskin --nomakefile -o ${PROJECT_EXE_DIR} ${OPT_B} "${basename_py}"
    ...
    if(AS_EXT)
        ...
        add_custom_command(OUTPUT ${translated_files}
            COMMAND shedskin --nomakefile -o ${PROJECT_EXT_DIR} -e ${OPT_B} "${basename_py}"
            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
            DEPENDS "${basename_py}"
