...
if __name__ == '__main__':
    ...
    print('%.8f' % math.erf(2))
    print('%.8f' % math.erfc(2))
    print('%.8f' % math.expm1(2))
    print(math.frexp(2))
    print(math.gamma(2))
    print(math.lgamma(2))
    ...
    print('%.8f' % math.log1p(1))

    print('%.8f' % math.acosh(1))
    print('%.8f' % math.acosh(2))
    print(math.isinf(math.asinh(float("inf"))))

    print('%.8f' % math.asinh(0))
    print('%.8f' % math.asinh(1))
    print('%.8f' % math.asinh(-1))
    print(math.isinf(math.asinh(float("inf"))))

    print('%.8f' % math.atanh(0))
    print('%.8f' % math.atanh(0.5))
    print('%.8f' % math.atanh(-0.5))
