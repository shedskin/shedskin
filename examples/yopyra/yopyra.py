...
class Scene:
    def __init__(self, scene_filename):
        lines = [l.split() for l in open(scene_filename) if l.strip() and l.strip()[0] != "#"]
        self.lObjetos = []
        self.lLuces = []
        self.lMateriales = []
...
def main():
    ...
    print("P3", file=fileout)
    print(scene.imgAncho, scene.endline - scene.startline + 1, file=fileout)
    print("255", file=fileout)
