...
function(add_shedskin_product)
    ...
    foreach(mod ${sys_modules})
        ...
        elseif(mod STREQUAL "math")
            list(APPEND sys_module_list "${SHEDSKIN_LIB}/math/__init__.cpp")
            list(APPEND sys_module_list "${SHEDSKIN_LIB}/math/__init__.hpp")
        elseif(mod STREQUAL "math.integer")
            list(APPEND sys_module_list "${SHEDSKIN_LIB}/math/integer.cpp")
            list(APPEND sys_module_list "${SHEDSKIN_LIB}/math/integer.hpp")
        else()
            if(mod STREQUAL "re")
