...
class_ *cl_class_, *cl_none, *cl_str_, *cl_int_, *cl_bool, *cl_float_, *cl_list, *cl_tuple, *cl_dict, *cl_set, *cl_object, *cl_rangeiter, *cl_xrange;
...
complex_ *___box(complex i) {
    return new complex_(i);
}

complex_::complex_(complex i) {
    this->unit = i; 
}

str *complex_::__repr__() {
    return __add_strs(4, __str(unit.real), new str("+"), __str(unit.imag), new str("j"));
}
