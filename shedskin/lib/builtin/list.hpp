...
public:
    ...
    bool __ss_site_grow_recorded = false;
#endif
...
#ifdef __SS_PREDICT
    if (this->__ss_site && !this->__ss_site_grow_recorded
            && this->units.size() == this->units.capacity()) {
        this->__ss_site_grow_recorded = true;
        __shedskin__::__list_site_grew(*this->__ss_site);
    }
#endif
