...
list<str *> *glob(str *pathname, __ss_bool recursive=False, __ss_bool include_hidden=False, str *root_dir=0);
__iter<str *> *iglob(str *pathname, __ss_bool recursive=False, __ss_bool include_hidden=False, str *root_dir=0);
