...
template<class T> struct Cmp {
    inline int operator()(T& first, T& second) const {
...
template<class T, class U, template <class V, class W> class X, template <class Y> class Cmp> inline void _siftdown(X<T, U>& heap, int startpos, int pos) {
...
template<class T, class U, template <class V, class W> class X> inline void _siftdown(X<T, U>& heap, int startpos, int pos) {
...
template<class T, class U, template <class V, class W> class X, template <class Y> class Cmp> inline void _siftup(X<T, U>& heap, int pos) {
    assert(pos < heap.size());
...
template<class T, class U, template <class V, class W> class X> inline void _siftup(X<T, U>& heap, int pos) {
...
public:
    typedef std::pair<int, T> iter_heap;
    ...
    friend mergeiter<T> *merge<T>(int iterable_count, pyiter<T> *iterable, ...);
};
...
public:
    ...
    nheapiter();
    nheapiter(int n, pyiter<T> *iterable);
...
template<class T, template <class Y> class Cmp> inline nheapiter<T, Cmp>::nheapiter(int n, pyiter<T> *iterable) {
...
template<class T> nheapiter<T, Cmp> *nlargest(int n, pyiter<T> *iterable) {
    return new nheapiter<T, Cmp>(n, iterable);
}

template<class T> nheapiter<T, InvCmp> *nsmallest(int n, pyiter<T> *iterable) {
