...
tuple2<__ss_float, __ss_float> *rgb_to_yiq(__ss_float r, __ss_float g, __ss_float b) {
    ...
    __ss_float i = ((0.74*(r-y))-(0.27*(b-y)));
    __ss_float q = ((0.48*(r-y))+(0.41*(b-y)));
...
tuple2<__ss_float, __ss_float> *yiq_to_rgb(__ss_float y, __ss_float i, __ss_float q) {
    __ss_float r = std::clamp((y+(0.9468822170900693*i))+(0.6235565819861433*q), 0., 1.);
    __ss_float g = std::clamp((y-(0.27478764629897834*i))-(0.6356910791873801*q), 0., 1.);
    __ss_float b = std::clamp((y-(1.1085450346420322*i))+(1.7090069284064666*q), 0., 1.);
